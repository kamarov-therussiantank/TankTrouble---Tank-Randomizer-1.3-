...
function createCustomElement(tag, attr_tag, attr_name, value, appendToId) {
  const custom_element = document.createElement(tag);
  custom_element.setAttribute(attr_tag, attr_name);
  custom_element.innerHTML = value;
  document.getElementById(appendToId).appendChild(custom_element);
}
...
// Tell a Friend Snippet
  createCustomElement('div', 'id', 'tellAFriendSnippet', `
    <style>
      #tellAFriendSnippet {
        background: #000;
        border-radius: 5px;
    ...
    <img src="https://raw.githubusercontent.com/kamarov-therussiantank/TTCV2/main/images/snippets/tellAFriend.png" style="position: relative; top: 3px; left: 14px; pointer-events: none; width: 125px;">
  </div>
  `, 'tertiaryContent');
