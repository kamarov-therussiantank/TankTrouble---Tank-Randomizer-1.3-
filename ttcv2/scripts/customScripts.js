...
button.medium {
    ...
    min-width: 34px;
    line-height: 34px;
    background: #ccc url(https://code.jquery.com/ui/1.11.4/themes/smoothness/images/ui-bg_glass_75_dadada_1x400.png) 50% 50% repeat-x;
    color: #000
}
button.warning {
...
button:disabled {
    background: #999 url(https://code.jquery.com/ui/1.11.4/themes/smoothness/images/ui-bg_glass_75_dadada_1x400.png) 50% 50% repeat-x;;
    cursor: default;
    color: #8b8b8b;
}
.buttonGroup div.selected button {
    text-shadow: 0 0 4px #ffffff, 0 0 4px #fff700, 0 0 5px #ffda00, 0 0 10px #ffe237;
}
    .box .tab.right {
        background: #999;
    }
